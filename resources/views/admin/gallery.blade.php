                    ...
                    <div class="element-box attachment-library">
                        ...
                        <div class="row gallery-list">
                            ...
                            <div class="col-sm-2 gallery-item">
                                <img src="{{ $image->getRelativePathname() }}" data-size="{{ $image->size }} B"
                                    data-filename="{{ $image->getFilename() }}" class="img-responsive">
                            </div>
                            @endforeach
                        </div>
                        @endif
...
<script src="{{ asset("js/admin/custom/gallery.js") }}"></script>
@endsection
