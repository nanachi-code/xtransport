                    ...
                    <div class="slider-pro">
                        <div class="sp-slides">
                            <div class="sp-slide">
                                ...
                                <p class="kopa-txt-style-05 sp-layer" data-horizontal="230" data-vertical="310" data-show-transition="left" data-show-delay="400">exprienced</p>
                                <p class="kopa-txt-style-06 sp-layer" data-horizontal="140" data-vertical="350" data-show-transition="left" data-show-delay="600">We have over fifty years of combined experience.</p>
                                <p class="sp-layer kopa-sp-layer-btn-01" data-horizontal="100" data-vertical="430" data-show-transition="left" data-show-delay="800"><a href="#" class="btn-01">learn more</a>
                                </p>
                                <p class="sp-layer kopa-sp-layer-btn-02" data-horizontal="330" data-vertical="430" data-show-transition="left" data-show-delay="800"><a href="#" class="btn-01">contact us</a>
                                </p>
                            ...
                            <div class="sp-slide">
                                ...
                                <p class="sp-layer kopa-sp-layer-btn-04" data-horizontal="735" data-vertical="380" data-show-transition="left" data-show-delay="800"><a href="#" class="btn-04">get your quote</a>
                                </p>
                        ...
                        <div class="widget ex-module-about-us-1">
                            ...
                            <div class="widget-content">
                                <article class="entry-item">
                                    ...
                                    <div class="entry-content">
                                        <p>On moving day, sit back and let Atlas carry the load. It's what we do best. Experienced crews protect your home, load, and move your items all the way to your new place, including placing the furniture where you want it. You've got it in you to go new places.</p>
                                    </div>
                                    ...
                                    <li class="col-xs-12 col-lg-6">
                                        <article class="entry-item">
                                            ...
                                            <div class="entry-content">
                                                ...
                                                <p>Tex Trucking is one of the most trusted names in trucking, and an industry leader in home</p>
                                            </div>
                                        </article>
                                    </li>
                                    <!-- * -->
                                ...
                                <ul class="owl-carousel owl-theme">
                                    ...
                                    <li>
                                        <article class="entry-item">
                                            <div class="entry-content">
                                                <figure class="entry-thumb">
                                                    <a href="#"><img src="{{ asset("uploads/{$company->avatar}") }}" alt="{{$company->name}}">
                                                    </a>
                                                </figure>
                                            </div>
                                        </article>
