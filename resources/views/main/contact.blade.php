    ...
    <div class="container">
        <div class="row ul-mh ct-row-02">
            ...
            <div class="col-xs-12 col-sm-6 ct-col-02 col-md-8  ">
                ...
                <!-- ======================== -->
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.092938382334!2d105.7796333142453!3d21.028966993148757!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313454b3285df81f%3A0x97be82a66bbe646b!2sDetech%20Building!5e0!3m2!1svi!2s!4v1588577870608!5m2!1svi!2s"
                    width="600" height="513" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false"
                    tabindex="0"></iframe>
                <!-- ======================= -->
                <!-- end -->
            </div>
            ...
            <div class="col-xs-12  ct-col-02 style-wrap-02">
                <div class="widget ex-module-contact-12">
                    <header class="widget-header style-08">
                        ...
                        <span class="sub-title color-title-3">In our clinic we use only the high quality materials and
                            the most modern methods and procedures. To accelerate the process of bleaching we use a
                            special lamps which also make the bleaching more friendly to your teeth. You will be leaving
                            our office with a nice bright smile.</span>
                    </header>
                    <div class="widget-content">
                        <article class="entry-item">
                            <div class="entry-content">
                                <!--  ======================================== -->
                                <form class="ct-form-1 form-style-1" method="post" novalidate="novalidate"
                                    action="{{url("/contact/feedback")}}" id="contact-feedback">
                                    @csrf
                                    <div class="row">
