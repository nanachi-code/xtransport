        ...
        <div class="widget kopa__topPage style--01">
            <div class="kopa__topPage--left">
                ...
                <div class="kopa__breadcrumb style--01"><span>You are here:</span><i
                        class="fa fa-angle-double-right"></i><a href="{{url('/')}}">Home</a><i
                        class="fa fa-angle-double-right"></i><span>Contact us</span></div>
                <!-- breadcrumb-->
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <div class="widget kopa__contact style--03">
                    <div class="widget-title style--08">
                        ...
                        <!-- kopa line dotted-->
                        <p class="text__title">Tagoking is one of the world's leading non-asset supply chain management
                            companies,
                            ...
                            Developed by 3 members Dinh Vu, Dao Ngoc Long and Ho Ly Thai. We are honored to serve you.
                        </p>
                    </div>
                    <!-- widget title-->
                    <div class="widget-content">
                        ...
                        <div class="kopa_formContact style--01">
                            <div class="wpcf7">
                                ...
                                <form action="{{url("/contact/feedback")}}" id="contact-feedback" method="post"
                                    class="wpcf7-form">
                                    @csrf
                                    <p><span class="wpcf7-form-control-wrap your-name">
                                            <input type="text" name="name" placeholder="Name *"
                                                class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"></span>
                                    </p>
                                    ...
                                    <p><span class="wpcf7-form-control-wrap your-message">
                                            <textarea placeholder="Comment" name="comment"
                                                class="wpcf7-form-control wpcf7-textarea"></textarea></span></p>
                                    <p>
                                        <button type="submit" id="contact-feedback"
                                            class="wpcf7-form-control wpcf7-submit btn btn--md btn--curve btn__color--primary">Send
                                            Feedback</button>
                                    </p>
                                </form>
                            </div>
            ...
            <div class="col-xs-12 col-sm-6"><iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d931.0241956440349!2d105.78173522916106!3d21.028813150912438!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313454b3285df81f%3A0x97be82a66bbe646b!2sDetech%20Building!5e0!3m2!1svi!2s!4v1587532938929!5m2!1svi!2s"
                    width="600" height="800" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false"
