...
$(function() {
    ...
    function os_apply_customizations() {
        ...
        $(".menu-w")
            .addClass("color-scheme-" + menu_color_scheme)
            .addClass("color-style-" + menu_color_style);
        ...
        if (menu_layout == "mini") {
            ...
            if (menu_position == "left") {
                $(".menu-actions .os-dropdown-trigger").removeClass(function(
                    ...
                    return (
                        className.match(/(^|\s)os-dropdown-position-\S+/g) || []
                    ).join(" ");
                });
        ...
        else $(".top-bar").addClass("d-none");

        // Full screen selector
        if ($(".full-screen-selector").val() == "yes")
            $("body").addClass("full-screen");
        else $("body").removeClass("full-screen");
