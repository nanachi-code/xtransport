    ...
    if (typeof Chart !== "undefined") {
        ...
        if ($("#liteLineChart").length) {
            ...
            if (liteLineChart.data("chart-data"))
                chartData = liteLineChart.data("chart-data").split(","); // line chart data
        ...
        if ($("#liteLineChartV2").length) {
            ...
            if (liteLineChartV2.data("chart-data"))
                chartDataV2 = liteLineChartV2.data("chart-data").split(","); // line chart data
        ...
        if ($("#liteLineChartV3").length) {
            ...
            if (liteLineChartV3.data("chart-data"))
                chartDataV3 = liteLineChartV3.data("chart-data").split(","); // line chart data
